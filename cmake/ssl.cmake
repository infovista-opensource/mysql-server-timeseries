...
MACRO(MYSQL_CHECK_SSL_DLLS)
  IF (WITH_SSL_PATH AND (APPLE OR WIN32 OR LINUX_STANDALONE OR LINUX_RPM))
    ...
    IF(WIN32)
      ...
      MESSAGE(STATUS "Looking for ${CRYPTO_NAME} ${SSL_MSVC_VERSION_SUFFIX} ${SSL_MSVC_ARCH_SUFFIX}.dll and ${CRYPTO_NAME} ${SSL_MSVC_VERSION_SUFFIX}.dll in ${WITH_SSL_PATH}/bin")
      ...
      MESSAGE(STATUS "Looking for ${OPENSSL_NAME}${SSL_MSVC_VERSION_SUFFIX}${SSL_MSVC_ARCH_SUFFIX}.dll and ${OPENSSL_NAME}${SSL_MSVC_VERSION_SUFFIX}.dll in ${WITH_SSL_PATH}/bin")
